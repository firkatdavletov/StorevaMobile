...
import ru.storeva.android.navigation.RootComponent.BottomChild.*
import ru.storeva.android.navigation.RootComponent.Child.AppIntroduction
import ru.storeva.android.navigation.RootComponent.Child.Cart
import ru.storeva.android.navigation.RootComponent.Child.Catalog
import ru.storeva.android.navigation.RootComponent.Child.CurrentOrder
import ru.storeva.android.navigation.RootComponent.Child.Home
import ru.storeva.android.navigation.RootComponent.Child.Launch
import ru.storeva.android.navigation.RootComponent.Child.Payment
import ru.storeva.android.navigation.RootComponent.Child.Profile
import ru.storeva.android.navigation.RootComponent.Child.SearchAddress
import ru.storeva.android.navigation.RootComponent.Child.SelectAddress
import ru.storeva.android.navigation.RootComponent.Child.SignIn
import ru.storeva.android.navigation.RootComponent.Child.Verification
        ...
        val callbacks = HomeCallbacks(
            navigateToMap = {
                if (!childStack.items.any {
                        it.configuration == Config.SelectAddress(HomeComponent::class.simpleName)
                    }
                ) {
            ...
            navigateToOrder = { orderId ->
                if (!childStack.items.any {
                        it.configuration == Config.CurrentOrder(HomeComponent::class.simpleName, orderId)
                    }
                ) {
